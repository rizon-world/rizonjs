...
import { QueryClientImpl as TransferQuery, QueryDenomTraceResponse, QueryDenomTracesResponse, QueryParamsResponse as QueryTransferParamsResponse } from '../codec/ibc/applications/transfer/v1/query';
import {
    ...
    return {
        ibc: {
            channel: {
                ...
                consensusState: async (portId: string, channelId: string, revisionNumber: number, revisionHeight: number) =>
                ...
                unreceivedPackets: async (portId: string, channelId: string, packetCommitmentSequences: readonly number[]) =>
                ...
                consensusState: async (clientId: string, consensusHeight?: number) =>
                    clientQueryService.ConsensusState(
                        QueryConsensusStateRequest.fromPartial({
                            clientId: clientId,
                            revisionHeight: consensusHeight !== undefined ? Long.fromNumber(consensusHeight, true) : undefined,
